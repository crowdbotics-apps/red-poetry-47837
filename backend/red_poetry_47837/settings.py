"""
Django settings for red_poetry_47837 project.
...
ROOT_URLCONF = 'red_poetry_47837.urls'
...
WSGI_APPLICATION = 'red_poetry_47837.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_poetry_47837 API",
    "DESCRIPTION": "API documentation for red_poetry_47837 App",
    "VERSION": "v1",
}
